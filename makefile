...
LAYOUT := marco-custom
# --- all
LAYOUTS := qwerty-kinesis-mod dvorak-kinesis-mod colemak-symbol-mod workman-p-kinesis-mod marco-custom
...
clean:
	git clean -f -dX  # remove ignored files and directories
	-rm -rf '$(BUILD)'
